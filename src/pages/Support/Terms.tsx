...
export default function Terms() {
  ...
  return (
    ...
    >
      ...
      >
        Welcome to wibhoo! <br /> <br /> ​These terms and conditions outline the
        rules and regulations for the use of WIBHOO's Website, located at
        https://www.wibhoo.shop. By accessing this website we assume you accept
        these terms and conditions. Do not continue to use wibhoo if you do not
      ...
      >
        ...
        cookies in agreement with the WIBHOO's Privacy Policy. Most interactive
      ...
      >
        ...
        wibhoo for your own personal use subjected to restrictions set in these
      ...
      >
        ...
        WIBHOO does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of WIBHOO,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, WIBHOO shall not be liable for the
      ...
      <Typography
        ...
        sx={{ marginBottom: 2, color: "white", lineHeight: 2 }}
      >
        You hereby grant WIBHOO a non-exclusive license to use, reproduce, edit
      ...
      >
        ...
        the hyperlink compensates the absence of WIBHOO; and (d) the link is in
      ...
      >
        ...
        e-mail to WIBHOO. Please include your name, your organization name,
